...
const notifications = [
  {
    ...
    text: '<span class="_notify_txt_link">Steve Jobs</span> posted a link in your timeline.',
    time: '42 minutes ago',
  },
  {
    id: 2,
    image: '/assets/images/profile-1.png',
    text: 'An admin changed the name of the group <span class="_notify_txt_link">Freelacer usa</span> to <span class="_notify_txt_link">Freelacer usa</span>',
    time: '42 minutes ago',
  },
];
      ...
      <div id="_notify_drop" className={`_notification_dropdown ${isOpen ? 'show' : ''}`}>
        <div className="_notifications_content">
          ...
          <div className="_notification_box_right">
            <button type="button" className="_notification_box_right_link" onClick={toggleMore}>
            ...
            <div className={`_notifications_drop_right ${isMoreOpen ? 'show' : ''}`}>
            ...
            {notifications.map((notif) => (
              <div key={notif.id} className="_notification_box">
                ...
                <div className="_notification_txt">
                  <p className="_notification_para" dangerouslySetInnerHTML={{ __html: notif.text }} />
